...
ENT.Name = "Home Run Bat"
ENT.PickupSound = Sound("weapons/draw_sword.wav")
ENT.IsPropWeapon = true

ENT.Model = Model("models/weapons/c_models/c_wooden_bat/c_wooden_bat.mdl")
ENT.ThrowForce = 850
...
function ENT:PrimaryAttack(pl)
	if pl:CanMelee() then
		pl:SetState(STATE_HOMERUNBATATTACK, STATES[STATE_HOMERUNBATATTACK].Time)
	end
