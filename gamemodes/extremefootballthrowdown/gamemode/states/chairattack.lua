...
function STATE:Started(pl, oldstate)
	...
	pl:SetStateBool(false)
			if SERVER then
			pl:EmitSound("physics/metal/metal_grate_impact_soft"..math.random(1,3)..".wav", 75, math.random(127, 153))
		end
end
...
function STATE:HitEntity(pl, hitent, tr)
	...
	hitent:ThrowFromPosition(pl:GetLaunchPos(), 600, knockdown, pl)
	if knockdown then
